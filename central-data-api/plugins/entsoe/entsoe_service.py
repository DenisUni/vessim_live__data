...
class EntsoeService:
    ...
    def __init__(self, api_key: str):
        ...
        self.client = None
        self.logger = setup_logger(__name__, "ENTSOE-SERVICE")
        ...
        if api_key:
            try:
                ...
                self.logger.warning("entsoe-py not installed")
        else:
            self.logger.warning("No ENTSO-E API Key found!")
    ...
    def check_connection(self) -> bool:
        ...
        try:
            ...
            self.logger.warning(f"ENTSO-E API connection check warning: {e}")
