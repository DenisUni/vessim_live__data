...
def discover_and_load_plugins():
    ...
    # Define the plugin package
    plugins_package = "plugins"
    plugin_routers = []
    plugin_models = []
    plugin_startups = []

    # Browse all modules in the plugins package
    try:
    ...
    # Find all subpackages (plugin folders)
    for _, plugin_name, is_pkg in pkgutil.iter_modules([str(package_path)]):
        ...
        try:
            ...
            # Check for standard API attributes (convention over configuration)
...
async def app_lifespan(app: FastAPI):
    ...
    # Add all found routers to the app
